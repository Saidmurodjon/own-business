              ...
              <div className="grid grid-cols-1 gap-5 md:grid-cols-2 mt-5">
                ...
                <div>
                  ...
                  <PhoneInput
                    defaultCountry="UZ"
                    name="phone_number"
                    className="w-full bg-gray-100 text-gray-900 mt-2 p-3 rounded-lg outline-none"
                    placeholder="Phone*"
                    value={phone}
                    international={true}
                    onChange={setPhone}
            ...
            <div className="flex flex-col text-white">
              <div className="flex my-4 w-2/3 lg:w-3/4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Fergana,Oybek 24</p>
                </div>
              </div>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Tel: +998911312071</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">info@optimum.uz</p>
                  </div>
                </div>
              </div>
